...
citations <- tibble(longname = c('De Mutsert et al. 2017',
  ...
  bind_rows(tibble(longname = c('Leading stanza', 'Solved by Rpath', 'Sensitivity of results to this paramter was minimal', ''), 
...
cite.mat['Diving Birds',] <- c('', 'g2012', 'g2012', 'g2012', rpath., '')
cite.mat['Pelicans',] <- c('', 'g2012', 'g2012', 'g2012', rpath., '')
cite.mat['Marsh Birds',] <- c('', 'd2014', 'd2014', 'd2014', rpath., '')
cite.mat['Dolphins',] <- c('', 'm2017', 'm2017', 'b2017', rpath., '')
cite.mat['Killifishes',] <- c('', d2017, d2017, d2017, rpath., '')
cite.mat['Juv Panaeids',] <- c(lead, d2017, d2017, d2017, rpath., '')
cite.mat['Adu Panaeids',] <- c('', rpath., d2017, rpath., rpath., d2017)
