### KIVA - I think this is all you need to run Ecopath. If
# you want to run older models, there might be another function to help load parameters
# But if you are entering you own parameters, I think you just need
# the runecopath function below. 
